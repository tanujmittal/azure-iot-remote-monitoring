...
using Microsoft.Azure.Devices.Applications.RemoteMonitoring.Simulator.WebJob.CGMDevice.CommandProcessors;
using Microsoft.Azure.Devices.Applications.RemoteMonitoring.Simulator.WebJob.CGMDevice.Telemetry;
...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.Simulator.WebJob.CGMDevice.Devices
{
    /// <summary>
    /// Implementation of a specific device type that extends the BaseDevice functionality
    /// </summary>
    public class CBGMDevice : DeviceBase
    {
        ...
        {
            var remoteMonitorTelemetry = (CGMRemoteMonitorTelemetry)_telemetryController;
