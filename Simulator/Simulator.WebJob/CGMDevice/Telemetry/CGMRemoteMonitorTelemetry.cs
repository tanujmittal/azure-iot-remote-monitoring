...
using Microsoft.Azure.Devices.Applications.RemoteMonitoring.Simulator.WebJob.CGMDevice.Telemetry.Data;
using Microsoft.Azure.Devices.Applications.RemoteMonitoring.Simulator.WebJob.SimulatorCore.Logging;
using Microsoft.Azure.Devices.Applications.RemoteMonitoring.Simulator.WebJob.SimulatorCore.Telemetry;

namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.Simulator.WebJob.CGMDevice.Telemetry
{
    public class CGMRemoteMonitorTelemetry : ITelemetry, ITelemetryWithInterval, ITelemetryWithTemperatureMeanValue, ITelemetryFactoryResetSupport
    {
        ...
        public CGMRemoteMonitorTelemetry(ILogger logger, string deviceId)
        {
            _logger = logger;
            _deviceId = deviceId;
        ...
        {
            var monitorData = new CGMRemoteMonitorTelemetryData();
            string messageBody;
